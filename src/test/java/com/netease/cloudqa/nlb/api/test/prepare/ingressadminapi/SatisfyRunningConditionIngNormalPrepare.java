...
public class SatisfyRunningConditionIngNormalPrepare extends BasePrepare {

    //netflow mix欠费停服恢复
    @CaseLabel(lbType = { "mix" })
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder satisfyRunningConditionIng001() {
        ...
        DataUnits.add(new DataUnit("caseId", String.class.toString(), "satisfyRunningConditionIng001", null));
    ...
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder satisfyRunningConditionIng002() {
        DataHolder holder = new DataHolderImpl();
        List<DataUnit> DataUnits = new ArrayList<DataUnit>();
        ...
        DataUnits.add(new DataUnit("caseId", String.class.toString(), "satisfyRunningConditionIng002", null));
