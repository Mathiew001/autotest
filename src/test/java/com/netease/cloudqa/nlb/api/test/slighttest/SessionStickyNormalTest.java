...
public class SessionStickyNormalTest extends ApiTestBase {

    @Test(dataProvider = "YamlDriverDataProvider", description = "UrlFlow NormalTest")
    public void apiTest(final String caseId, final String description, final String tenantId,
                        final String targetGroup, final String listener,
        ...
        getTestCaseTemplate().process(caseId, new TestCaseCallBack() {
            ...
            public void executeTest() {
                ...
                if (lb.getListeners().get(0).getClusters().get(0).getPolicy().getMode().equals("insert")) {
                    ...
                    assertTrue(NetUtils.checkSessionStickyRewrite(lb), caseId);
                }
