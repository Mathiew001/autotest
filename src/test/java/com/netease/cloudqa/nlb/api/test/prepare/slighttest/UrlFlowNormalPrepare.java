...
public class UrlFlowNormalPrepare extends BasePrepare {

    //mix url test
    @CaseLabel(lbType = { "mix" })
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder urlFlowNormalPrepare001() {
    ...
    @CaseLabel(lbType = { "mix" })
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder urlFlowNormalPrepare002() {
        DataHolder holder = new DataHolderImpl();
        List<DataUnit> DataUnits = new ArrayList<DataUnit>();
        String realServer1 = ConfigLoader.configration.getExtConfig("real_server1");
        String realServer2 = ConfigLoader.configration.getExtConfig("real_server2");
        ...
        DataUnits.add(new DataUnit("caseId", String.class.toString(), "urlFlowNormalPrepare002", null));
        DataUnits.add(new DataUnit("description", String.class.toString(), "url flow normal test of mix", null));
        DataUnits.add(new DataUnit("tenantId", String.class.toString(), ConfigLoader.configration.getExtConfig("tenant_id"), null));
        DataUnits.add(new DataUnit("targetGroup", String.class.toString(), targetGroup, null));
        DataUnits.add(new DataUnit("listener", String.class.toString(), listener, null));
    ...
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder urlFlowNormalPrepare003() {
        DataHolder holder = new DataHolderImpl();
        List<DataUnit> DataUnits = new ArrayList<DataUnit>();
        ...
        DataUnits.add(new DataUnit("caseId", String.class.toString(), "urlFlowNormalPrepare003", null));
        DataUnits.add(new DataUnit("description", String.class.toString(), "url flow normal test of vpc_mix", null));
        DataUnits.add(new DataUnit("tenantId", String.class.toString(), ConfigLoader.configration.getExtConfig("tenant_id"), null));
        DataUnits.add(new DataUnit("targetGroup", String.class.toString(), targetGroup, null));
        DataUnits.add(new DataUnit("listener", String.class.toString(), listener, null));
        DataUnits.add(new DataUnit("urlCheckList", String.class.toString(), urlCheckList, null));
    ...
    @CaseLabel(lbType = { "mix" })
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder urlFlowNormalPrepare004() {
        DataHolder holder = new DataHolderImpl();
        List<DataUnit> DataUnits = new ArrayList<DataUnit>();
        String realServer1 = ConfigLoader.configration.getExtConfig("real_server1_vpc");
        String realServer2 = ConfigLoader.configration.getExtConfig("real_server2_vpc");
        ...
        DataUnits.add(new DataUnit("caseId", String.class.toString(), "urlFlowNormalPrepare004", null));
        DataUnits.add(new DataUnit("description", String.class.toString(), "url flow normal test of vpc_mix", null));
        DataUnits.add(new DataUnit("tenantId", String.class.toString(), ConfigLoader.configration.getExtConfig("tenant_id"), null));
        DataUnits.add(new DataUnit("targetGroup", String.class.toString(), targetGroup, null));
        DataUnits.add(new DataUnit("listener", String.class.toString(), listener, null));
