...
public class UpdateTGInstanceAbnormalPrepare extends BasePrepare {

    //修改单个云主机权重, 权重不合法
    @CaseLabel(lbType = { "mix" })
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder UpdateTGInstanceAbnormal001() {
        ...
        DataUnits.add(new DataUnit("description", String.class.toString(), "update one TGInstance of mix, invalid weight", null));
    ...
    @CaseLabel(lbType = { "mix" })
    @PrepareDescription(isPrepareMethod = true)
    public DataHolder UpdateTGInstanceAbnormal002() {
        DataHolder holder = new DataHolderImpl();
        List<DataUnit> DataUnits = new ArrayList<DataUnit>();
        ...
        DataUnits.add(new DataUnit("caseId", String.class.toString(), "UpdateTGInstanceAbnormal002", null));
        DataUnits.add(new DataUnit("description", String.class.toString(), "update two TGInstance of mix, invalid weight", null));
        DataUnits.add(new DataUnit("tenantId", String.class.toString(), ConfigLoader.configration.getExtConfig("tenant_id"), null));
        DataUnits.add(new DataUnit("createBody", String.class.toString(), createBody, null));
        DataUnits.add(new DataUnit("updateBody", String.class.toString(), updateBody, null));
        DataUnits.add(new DataUnit("resMsg", String.class.toString(), resMsg, null));
