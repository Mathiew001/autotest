 ...
 *
 * @author chentianyu1
 * @version $Id: DeleteTargetGroupAbormalTest.java, v 0.1 Apr 27, 2018 1:13:33 PM chentianyu1 Exp $
 */
public class DeleteTargetGroupAbnormalTest extends ApiTestBase {
    @Test(dataProvider = "YamlDriverDataProvider", description = "DeleteTargetGroup AbnormalTest")
    public void apiTest(final String caseId, final String description, final String tenantId,
        ...
        getTestCaseTemplate().process(caseId, new TestCaseCallBack() {
            ...
            public void executeTest() {
                ...
                Response res = CommonApi.deleteTg(headers, httpClient, bodyJson.getString("InstanceId"),
                        bodyJson.getString("TargetGroupId"));
