...
public class UpdateLbListenerIngNormalTest extends ApiTestBase {
    ...
    public void apiTest(final String caseId, final String description, final String tenantId,
        ...
        getTestCaseTemplate().process(caseId, new TestCaseCallBack() {
            ...
            public void executeTest() {
                ...
                res = CommonApi.createLnIng(headers, executeBodyArray.getJSONObject(0), httpClient);
                ...
                res = CommonApi.updateLnIng(headers, executeBodyArray.getJSONObject(1), httpClient);
                assertEquals(res.getCode(), 204, "Update lb listener status code != 204");
                logger.info("Update ing listener successfully!");
                res = CommonApi.getLbDetailIng(headers, httpClient, lb.getInstanceId());
