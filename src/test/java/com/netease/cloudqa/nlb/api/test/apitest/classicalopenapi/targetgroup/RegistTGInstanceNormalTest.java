...
public class RegistTGInstanceNormalTest extends ApiTestBase {
    ...
    public void apiTest(final String caseId, final String description, final String tenantId,
        ...
        getTestCaseTemplate().process(caseId, new TestCaseCallBack() {
            ...
            public void executeTest() {
                ...
                Response res = CommonApi.registerTGInstance(headers, updateBodyJson, httpClient);
                assertEquals(res.getCode(), 200, caseId + " registTGInstance tg status code != 200");
