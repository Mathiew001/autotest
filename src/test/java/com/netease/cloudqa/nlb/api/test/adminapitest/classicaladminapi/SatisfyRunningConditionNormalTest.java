...
public class SatisfyRunningConditionNormalTest extends ApiTestBase {
...
//                logger.info("curl vip + port successfully!");
                res = CommonApi.notSatisfyRunningCondition(headers, httpClient, tenantId, resJson.getString("InstanceId"));
                ...
                res = CommonApi.satisfyRunningCondition(headers, httpClient, tenantId, resJson.getString("InstanceId"));
