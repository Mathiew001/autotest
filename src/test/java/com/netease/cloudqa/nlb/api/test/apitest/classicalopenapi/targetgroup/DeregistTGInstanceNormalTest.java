...
public class DeregistTGInstanceNormalTest extends ApiTestBase {

    @Test(dataProvider = "YamlDriverDataProvider", description = "RegistTGInstance NormalTest")
    public void apiTest(final String caseId, final String description, final String tenantId,
        ...
        getTestCaseTemplate().process(caseId, new TestCaseCallBack() {
            ...
            public void executeTest() {
                ...
                Response res = CommonApi.deregisterTGInstance(headers, updateBodyJson, httpClient);
                assertEquals(res.getCode(), 200, caseId + " deregistTGInstance tg status code != 200");
